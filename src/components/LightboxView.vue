			...
			<div class="ic-lb-bar">
				...
				<div class="ic-lb-bar-end">
					...
					>
						...
						<svg v-else viewBox="0 0 24 24" aria-hidden="true"><path d="M15 9H5V5h10m-3 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m5-16H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7z" /></svg>
					</button>
					<button
						v-if="currentAsset"
						class="ic-lb-btn"
					...
					>
						...
						<svg v-else viewBox="0 0 24 24" aria-hidden="true"><path d="M5 20h14v-2H5m14-9h-4V3H9v6H5l7 7z" /></svg>
					</button>
					<button
						v-if="currentAsset"
						class="ic-lb-btn"
					...
					>
						...
						<svg v-else viewBox="0 0 24 24" aria-hidden="true">
							<path v-if="isFavorite" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54z" />
					...
					>
						...
						<svg v-else viewBox="0 0 24 24" aria-hidden="true"><path d="M20 6h-8l-2-2H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2m-1 8h-3v3h-2v-3h-3v-2h3V9h2v3h3z" /></svg>
					</button>
					<button
						v-if="currentAsset"
						class="ic-lb-btn"
					...
					>
						...
						<svg v-else viewBox="0 0 24 24" aria-hidden="true"><path d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6z" /></svg>
					</button>
					<button
						class="ic-lb-btn"
					...
					>
						<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13 9h-2V7h2m0 10h-2v-6h2m-1-9A10 10 0 0 0 2 12a10 10 0 0 0 10 10 10 10 0 0 0 10-10A10 10 0 0 0 12 2z" /></svg>
					</button>
				...
				<div v-if="showAlbumPanel" class="ic-lb-info ic-lb-album-panel" @click.stop>
					...
					<template v-else>
						...
						<div v-if="!creatingAlbum"
							...
							<svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z" /></svg>
...
.ic-lb-arrow {
	...
	color: #fff;
	z-index: 10;
	transition: opacity 0.2s, right 0.28s cubic-bezier(.4,0,.2,1), left 0.28s cubic-bezier(.4,0,.2,1);
}
